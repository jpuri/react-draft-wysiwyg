...
import HashTagWithCustomComponent from './HashTagWithCustomComponent';
import Mention from './Mention';
import MentionWithCustomComponent from './MentionWithCustomComponent';
import I18n from './I18n';
import ToolbarHidden from './ToolbarHidden';
import ImageUpload from './ImageUpload';
import ImageUploadFocus from './ImageUploadFocus';
...
storiesOf('HashTag with Custom Component', module).add('story', () => <HashTagWithCustomComponent />);
storiesOf('Mention', module).add('story', () => <Mention />);
storiesOf('Mention with Custom Component', module).add('story', () => <MentionWithCustomComponent />);
...
storiesOf('ImageUpload and Toolbar on Focus', module).add('story', () => <ImageUploadFocus />);
