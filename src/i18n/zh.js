module.exports = {
  ...
  // Inline
  'components.controls.inline.bold': '加粗',
  ...
  'components.controls.list.unordered': '无序列表',
  'components.controls.list.ordered': '有序列表',
  'components.controls.list.indent': '缩进',
  'components.controls.list.outdent': '取消缩进',

  // Remove
  'components.controls.remove.remove': '移除',

  // TextAlign
  'components.controls.textalign.textalign': '对齐方式',
  'components.controls.textalign.left': '左对齐',
  'components.controls.textalign.center': '居中对齐',
  'components.controls.textalign.right': '右对齐',
